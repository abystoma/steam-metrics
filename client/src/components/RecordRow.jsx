    ...
    >
      <div className='flex items-center cursor-pointer hover:bg-category-bg rounded-lg'>
        <div className='flex items-center w-3/4'>
          <img
            className='w-36 rounded-md hidden md:block'
            src={`https://cdn.cloudflare.steamstatic.com/steam/apps/${data.id}/header.jpg`}
          />
          <p className='md:px-5 text-white font-pop_semi text-sm md:text-lg'>
            {data.data[0]}
          </p>
        </div>

        <div className='flex justify-around w-1/2 text-white font-pop_semi text-sm md:text-xl text-center'>
