...
const GameBanner = ({ game }) => {
  return (
    <div className='flex'>
      <img
        className='rounded-tl-xl rounded-bl-xl w-2/3 object-cover'
      ...
      <div className='bg-component-bg rounded-tr-xl rounded-br-xl w-[40%] p-5'>
        ...
        <div className='bg-price-btn rounded-md py-1 px-4 font-pop_med text-white my-5 inline-block text-xl'>
